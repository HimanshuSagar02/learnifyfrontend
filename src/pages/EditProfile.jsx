...
function EditProfile() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-10">
      <div className="bg-white rounded-2xl shadow-lg p-5 sm:p-8 max-w-xl w-full relative">
        <FaArrowLeftLong  className='absolute top-5 left-5 w-[20px] h-[20px] sm:w-[22px] sm:h-[22px] cursor-pointer' onClick={()=>navigate("/profile")}/>
