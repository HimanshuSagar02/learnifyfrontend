...
function Home() {
  ...
  const homeStructuredData = [
    {
      ...
      name: "Learnify",
      url: "https://learnifyedu.store",
      logo: "https://learnifyedu.store/logo.jpg?v=20260226",
      email: "support@learnifyedu.store",
      description:
        "Learnify is an AI-powered learning platform for web development, data structures, AI/ML, cloud, cybersecurity and language courses.",
      knowsAbout: [
        "Web Development",
        "Data Structures",
        "AI/ML",
  ...
  return (
    <>
      <Seo
        title="Learnify | Online Tech Courses for Web Development, AI/ML & Data Science"
        description="Learnify is an AI-powered online learning platform for web development, data structures, AI/ML, cloud, cybersecurity and language courses with mentor support."
        keywords={[
          "Learnify",
          "online tech courses",
