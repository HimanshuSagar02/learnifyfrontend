      ...
      <div className="max-w-7xl mx-auto flex lg:items-center items-start justify-center gap-[40px] lg:gap-[150px] flex-col lg:flex-row">
        ...
        <div className="lg:w-[40%] md:w-[50%] w-[100%]">
          ...
          <p className="text-sm text-white">
            Learnify - AI-powered learning platform to help you grow smarter. Learn anything, anytime, anywhere.
          </p>
        </div>
        ...
        <div className="lg:w-[30%] md:w-[100%]">
          ...
          <ul className="space-y-1 text-sm">
            <li className="hover:text-[#3B82F6] cursor-pointer transition-colors">Physics</li>
            <li className="hover:text-[#3B82F6] cursor-pointer transition-colors">Chemistry</li>
            <li className="hover:text-[#3B82F6] cursor-pointer transition-colors">Biology</li>
            <li className="hover:text-[#3B82F6] cursor-pointer transition-colors">Mathematics</li>
            <li className="hover:text-[#3B82F6] cursor-pointer transition-colors">NEET Preparation</li>
          </ul>
        </div>
