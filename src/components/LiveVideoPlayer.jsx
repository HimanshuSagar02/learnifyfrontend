...
function LiveVideoPlayer({ liveClassId, onClose, isEducator = false }) {
  ...
  return (
    <div className="fixed inset-0 bg-black z-50 flex flex-col">
      {/* Header */}
      <div className="bg-gray-900 text-white p-3 sm:p-4 flex justify-between items-center gap-2">
        <div className="flex items-center gap-2 sm:gap-4 min-w-0">
          <div>
            <h2 className="text-base sm:text-lg font-semibold">Live Class</h2>
      ...
      {/* Video Container */}
      <div className="flex-1 flex flex-col lg:flex-row gap-2 sm:gap-4 p-2 sm:p-4 relative overflow-hidden">
        {/* Remote Video (Main) */}
        ...
        {/* Local Video (Small) */}
        {localStream && (
          <div className="w-full max-w-[240px] h-36 sm:h-40 lg:w-64 lg:h-48 bg-gray-900 rounded-lg overflow-hidden relative shadow-lg">
            <video
              ref={localVideoRef}
              autoPlay
              playsInline
        ...
        {/* Chat Sidebar */}
        {showChat && (
          <div className="w-full lg:w-80 max-h-[40vh] lg:max-h-none bg-gray-800 rounded-lg flex flex-col shadow-lg">
      ...
      {/* Controls */}
      <div className="bg-gray-900 p-3 sm:p-4 flex justify-center items-center gap-2 sm:gap-4 flex-wrap">
        <button
          onClick={toggleVideo}
